                                ...
                                <form action="" method="POST">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input type="text" name="percent" class="form-control" placeholder="Enter Percent name">
                                        @error('percent')
                                            <span class="text-danger"><small>{{ $message }}</small></span>
                                        @enderror
                                      </div>
                                          ...
                                          <table class="table table-bordered table-hover" >
                                            ...
                                            <tbody>
                                              <tr>
                                                ...
                                                <td>{{ $skill->percent }}%</td>
                                                <td>
                                                  <a href="{{ url('/admin/skills/'. $skill->id .'/edit') }}" class="btn btn-primary">Edit</a>
                                                  {{-- <a href="{{ url('/admin/skills/'. $skill->id) }}" class="btn btn-danger">Delete</a> --}}
