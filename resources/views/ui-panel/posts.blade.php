            ...
            <div class="col-md-12">
              ...
              <div class="header">
                ...
                <div class="position-sticky" id="navbar">
                  <a href="{{ url('/') }}">HOME</a>
                  <a href="{{ url('/post-details') }}">BLOGS</a>
                </div>               
                           ...
                           <div class="row">
                               <div class="col-md-12">
                                <div class="post">
                                    ...
                                    <br><br>
                                        <h5><strong>HOW TO BECOME A PROFESSTIONAL WEB DEVELOPER</strong></h5>
                                    <br>
                                    <p>
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit debitis ducimus animi, molestias sequi quaerat? Minima modi numquam eligendi dignissimos doloribus beatae, autem adipisci, quidem laudantium corrupti nulla delectus dolore.
                                    </p>
                               ...
                               <div class="col-md-12">
                                <div class="post">
                                    <img src="images/post2.jpg" alt="" width="100%">
                                    <br><br>
                                        <h5><strong>HOW TO BECOME A PROFESSTIONAL WEB DEVELOPER</strong></h5>
                                    <br>
                                    <p>
                               ...
                               <div class="col-md-12">
                                <div class="post">
                                    <img src="images/post3.jpg" alt="" width="100%">
                                    <br><br>
                                        <h5><strong>HOW TO BECOME A PROFESSTIONAL WEB DEVELOPER</strong></h5>
                                    <br>
                                    <p>
                               ...
                               <div class="col-md-12">
                                <div class="post">
                                    <img src="images/post4.jpg" alt="" width="100%">
                                    <br><br>
                                        <h5><strong>HOW TO BECOME A PROFESSTIONAL WEB DEVELOPER</strong></h5>
                                    <br>
                                    <p>
                               ...
                               <div class="col-md-12">
                                <div class="post">
                                    <img src="images/post5.webp" alt="" width="100%">
                                    <br><br>
                                        <h5><strong>HOW TO BECOME A PROFESSTIONAL WEB DEVELOPER</strong></h5>
                                    <br>
                                    <p>
